...
$(document).ready(function () {
    ...
    $(".wysihtml5-toolbar li:first-child a:first-child").removeClass('btn-default').addClass('btn-light');
    $(".wysihtml5-toolbar li:nth-child(2) a").removeClass('btn-default').addClass('btn-light');
    $(".wysihtml5-toolbar li:nth-child(3) a").removeClass('btn-default').addClass('btn-light');
    $(".wysihtml5-toolbar li:nth-child(4) a").removeClass('btn-default').addClass('btn-light');
    $(".wysihtml5-toolbar li:nth-child(5) a").removeClass('btn-default').addClass('btn-light');
    $(".wysihtml5-toolbar li:nth-child(6) a").removeClass('btn-default').addClass('btn-light');
