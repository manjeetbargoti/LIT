...
<div class="outer">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Add Business Info</div>
                    <div class="card-body">
                        ...
                        <form class="form-horizontal login_validator" id="form_block_validator"
                            action="{{ url('/admin/profile/add-business') }}" method="post" accept-charset="UTF-8"
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="business_name" id="business_name"
                                                    class="form-control" value="{{ old('business_name') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Business name -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Email address"
                                                ...
                                                class="form-control" value="{{ old('alternate_contact_email_1') }}" required>
                                        </div>

                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Company name"
                                                id="alternate_contact_company_1" name="alternate_contact_company_1"
                                                class="form-control" value="{{ old('alternate_contact_company_1') }}" required>
                                        </div>
                                    </div>
                                    <!-- /. Alternate Person 1 information -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Email address"
                                                ...
                                                class="form-control" value="{{ old('alternate_contact_email_2') }}">
                                        </div>

                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Company name"
                                                id="alternate_contact_company_2" name="alternate_contact_company_2"
                                                class="form-control" value="{{ old('alternate_contact_company_2') }}">
                                        </div>
                                    </div>
                                    <!-- /. Alternate Person 2 information -->
                                    <div class="form-group row">
