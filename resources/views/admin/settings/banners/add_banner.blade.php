                        ...
                        action="{{ url('/admin/banner/add') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-10 {{ $errors->has('title') ? 'has-error' : ''}}">
                                    <input type="text" name="title" id="bannerTitle" maxlength="50" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-10 {{ $errors->has('small_text') ? 'has-error' : ''}}">
                                    <input type="text" name="small_text" id="smallText" maxlength="50" class="form-control">
                            ...
                            <div class="form-group">
                                <div class="col-xl-10 m-auto">
                                    ...
                                    <input class="btn btn-success pull-right" type="submit" value="Add Banner">
                                </div>
                            </div>
