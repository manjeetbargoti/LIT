...
<head>
    ...
    <!--<![endif]-->
    <title>A user submited contact query | {{ config('app.name') }}</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
    body {
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 46px; color: #003188;"><strong>Contact Query!</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <h2 style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 18px; mso-line-height-alt: 24px; margin: 0;">User Information,</h2>
                                                    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px; color: #6d89bc;">Name: {$name}</span>
                                                    </p>
                                                    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px; color: #6d89bc;">Email: {$email}</span>
                                                    </p>
                                                    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px; color: #6d89bc;">Phone: {$phone}</span>
                                                    </p>
                                                    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px; color: #6d89bc;">Message: {$message}</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
