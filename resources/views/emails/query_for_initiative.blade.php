...
<head>
    ...
    <!--<![endif]-->
    <title>Your Query Submited Successfully | {{ config('app.name') }}</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
    body {
                                        ...
                                        <div
                                            ...
                                            <div align="center" class="img-container center autowidth"
                                                ...
                                                <div style="font-size:1px;line-height:20px"> </div><img align="center"
                                                    ...
                                                    src="{{ url('images/logo/'.config('app.logo')) }}"
                                        ...
                                        <div
                                            ...
                                            <div align="center" class="img-container center autowidth"
                                                ...
                                                <img align="center" alt="I'm an image" border="0"
                                                    class="center autowidth" src="{{ url('/images/emailer/Invite_Illustration.png') }}"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 46px; color: #003188;"><strong>Query Submited!</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <h2 style="text-align: center; line-height: 1.5; word-break: break-word; font-family: inherit; font-size: 18px; mso-line-height-alt: 24px; margin: 0;">Dear {{ $name }},</h2>
                                                    <p
                                                        ...
                                                        <span style="font-size: 16px; color: #6d89bc;">Thanks for being
                                                            a part of LIT.</span><br /><span
                                                            style="font-size: 16px; color: #6d89bc;"> Your Query Submited Successfully! </span><span
                                                            style="font-size: 16px; color: #6d89bc;">Thank you for
                                                            being with us!</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                            ...
                                            <div align="center" class="img-container center autowidth"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                    ...
                                                    src="{{ url('/images/emailer/Divisor_Lines.png') }}"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 24px; color: #003188;"><strong>We're
                                                                curious</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <div align="center" class="button-container"
                                                style="padding-top:15px;padding-right:10px;padding-bottom:45px;padding-left:10px;">
                                                <div
                                                    style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#fb5f3d;border-radius:60px;-webkit-border-radius:60px;-moz-border-radius:60px;width:auto; width:auto;;border-top:1px solid #fb5f3d;border-right:1px solid #fb5f3d;border-bottom:1px solid #fb5f3d;border-left:1px solid #fb5f3d;padding-top:15px;padding-bottom:15px;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                    <span
                                                        style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;">
                                                        <a href="{{ url('/social-initiative/'.$slug) }}" style="font-size: 16px; line-height: 2; text-decoration:none;color: #fff; word-break: break-word; mso-line-height-alt: 32px;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">
                                                            <strong>Initiative you query about</strong>
                                                        </span></a>
                                                    </span></div>
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 4px;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="Facebook"
                                                                                    height="32"
                                                                                    src="{{ url('/images/emailer/facebook2x.png') }}"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 4px;"
                                                                            valign="top"><a href="https://twitter.com/"
                                                                                target="_blank"><img alt="Twitter"
                                                                                    height="32"
                                                                                    src="{{ url('/images/emailer/twitter2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 4px;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{ url('/images/emailer/instagram2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 4px;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="LinkedIn"
                                                                                    height="32"
                                                                                    src="{{ url('/images/emailer/linkedin2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
