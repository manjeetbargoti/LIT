...
<head>
    ...
    <title>Confirm Account | Lightup with LIT</title>
                    ...
                    <table width="600" cellspacing="0" cellpadding="0" border="0" align="center"
                        ...
                        <tr style="border-collapse:collapse;">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px;" height="0">
                                <img src="{{ url('/images/logo/logo_814.png') }}"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    ...
                                                                    <img src="{{ url('/images/logo/logo_814.png') }}" alt
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                    ...
                                                                    <h2 style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:20px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">Dear {{ $name }},</h2>
                                                                    <br>
                                                                    <p
                                                                        ...
                                                                        you need to confirm your account. Just press the
                                                                        button below.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto;"><a
                                                                            href="{{ url('/verify/token='.$token.'/code='.$code) }}"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-txt-l" align="left"
                                                                    style="padding:0;Margin:0;padding-top:14px;padding-left:30px;padding-right:30px;">
                                                                    <a target="_blank" href="{{ url('/verify/token='.$token.'/code='.$code) }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:underline;color:#FFA73B;">{{ url('/verify/token='.$token.'/code='.$code) }}</a></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-txt-l" align="left"
                                                                    style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;">
                                                                    <p
                                                                        ...
                                                                        email—we're always happy to help out.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-m-txt-l" align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td esdev-links-color="#ffa73b" align="center"
                                                                    ...
                                                                    <a target="_blank" href="{{ url('/contact-us') }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;text-decoration:underline;color:#FFA73B;">We’re
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;text-align:center;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;">
                                                                        {!! config('app.address') !!}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td class="es-infoblock made_with" align="center"
                                                                    ...
                                                                    <a target="_blank" href="{{ url('/') }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:12px;text-decoration:underline;color:#CCCCCC;">
                                                                        <img src="{{ url('/images/logo/logo_814.png') }}"
                                                                            alt width="125"
