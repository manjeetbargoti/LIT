...
<head>
    ...
    <!--<![endif]-->
    <title>User Profile Updated | {{ config('app.name') }}</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
    body {
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 46px; color: #003188;"><strong>Profile Updated!</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 16px; color: #6d89bc;">Thanks for being
                                                            ...
                                                            style="font-size: 16px; color: #6d89bc;"> Your personal details in profile updated successfully. </span><span
                                            ...
                                            <div align="center" class="button-container"
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        ...
                                                        <a href="{{ url('/admin/profile') }}" style="font-size: 16px; line-height: 2; text-decoration:none;color: #fff; word-break: break-word; mso-line-height-alt: 32px;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">
