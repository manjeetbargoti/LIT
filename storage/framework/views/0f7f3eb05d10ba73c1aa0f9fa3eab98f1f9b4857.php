...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('/front/css/tail.select-default.css')); ?>" />
...
<body>
    ...
    <script src="<?php echo e(asset('front/js/tail.select.min.js')); ?>"></script>
