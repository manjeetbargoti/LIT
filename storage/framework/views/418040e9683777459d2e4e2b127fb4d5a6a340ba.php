                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal login_validator" id="form_block_validator"
                            action="<?php echo e(url('/admin/profile/business/' . $businessData->id . '/update')); ?>" method="post" accept-charset="UTF-8"
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="business_name" id="business_name"
                                                    class="form-control" value="<?php echo e($businessData->business_name); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="business_description" id="business_description"
                                                class="form-control" value="<?php echo e(old('business_description')); ?>" rows="5"
                                                required><?php echo e($businessData->business_description); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Business Description -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="contact_person_name" id="contact_person_name"
                                                    class="form-control"
                                                    value="<?php echo e($businessData->contact_person_name); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Contact Person Name -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Email Address" id="email" name="email"
                                                    class="form-control" value="<?php echo e($businessData->email); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Contact Person Email Address -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder=" " id="phone" name="phone"
                                                    class="form-control" value="<?php echo e($businessData->phone); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Contact Person Phone Number -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder=" " id="trade_license_number"
                                                    ...
                                                    value="<?php echo e($businessData->trade_license_number); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Trade License Number -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <input id="input-21" type="file" accept="image/*" name="trade_license_image"
                                                ...
                                                <img src="<?php echo e(url('/images/tradeLicense/large/'.$businessData->trade_license_image)); ?>" class="img-responsive" width="250" alt="<?php echo e($businessData->business_name); ?>">
                                        </div>
                                    </div>
                                    <!-- /. Trade License Image -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="dd/mm/yyyy"
                                                    ...
                                                    value="<?php echo e($businessData->license_expiry_date); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. License Expiry Date -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Full name" id="alternate_contact_name_1"
                                                ...
                                                value="<?php echo e($businessData->alternate_contact_name_1); ?>" required>
                                        </div>

                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Job Profile" id="alternate_contact_job_1"
                                                name="alternate_contact_job_1" class="form-control"
                                                value="<?php echo e($businessData->alternate_contact_job_1); ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-3 text-lg-right">
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Email address"
                                                ...
                                                class="form-control"
                                                value="<?php echo e($businessData->alternate_contact_email_1); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Company name"
                                                ...
                                                class="form-control"
                                                value="<?php echo e($businessData->alternate_contact_company_1); ?>" required>
                                        </div>
                                    </div>
                                    <!-- /. Alternate Person 1 information -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Email address"
                                                ...
                                                class="form-control"
                                                value="<?php echo e($businessData->alternate_contact_email_2); ?>">
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6">
                                            <input type="text" placeholder="Company name"
                                                ...
                                                class="form-control"
                                                value="<?php echo e($businessData->alternate_contact_company_2); ?>">
                                        </div>
                                    </div>
                                    <!-- /. Alternate Person 2 information -->
                                    <div class="form-group row">
...
<?php echo $__env->make('layouts.panel.design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\LIT\resources\views/admin/profile/update_business.blade.php ENDPATH**/ ?>