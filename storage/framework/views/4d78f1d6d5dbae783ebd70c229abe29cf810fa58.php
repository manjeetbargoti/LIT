                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="form-horizontal login_validator" id="form_block_validator"
                            action="<?php echo e(url('/admin/social-impact/proposals/'.$proposal->id)); ?>" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <select name="business_id" id="CompanyName" class="form-control"
                                                    ...
                                                    <option value="<?php echo e($comp->id); ?>" <?php if($comp->id == $proposal->business_id): ?> selected <?php endif; ?>><?php echo e($comp->business_name); ?></option>
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="project_name" id="project_name"
                                                    class="form-control" value="<?php echo e($proposal->project_name); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Project name -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="contact_person_name" id="contact_person_name"
                                                    class="form-control" value="<?php echo e($proposal->contact_person_name); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control"
                                                    value="<?php echo e($proposal->email); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Contact Person Email -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="tel" name="phone" id="phone" class="form-control"
                                                    value="<?php echo e($proposal->phone); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Contact Person Phone -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="tel" name="fax_number" id="fax_number" class="form-control"
                                                    value="<?php echo e($proposal->fax_number); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Fax Number -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="company_background" id="company_background"
                                                ...
                                                required><?php echo e($proposal->company_background); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Company Background -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="project_description" id="project_description"
                                                ...
                                                required><?php echo e($proposal->project_description); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Project Description -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="project_goals" id="project_goals" class="form-control" rows="3" required><?php echo e($proposal->project_goals); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Project Goals -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="proposal_elements" id="proposal_elements"
                                                class="form-control" rows="3"><?php echo e($proposal->proposal_elements); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Project Elements -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="evolution_criteria" id="evolution_criteria"
                                                class="form-control" rows="2"><?php echo e($proposal->evolution_criteria); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Evolution Criteria -->
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <textarea name="possible_challanges" id="possible_challanges"
                                                class="form-control" rows="2"><?php echo e($proposal->possible_challanges); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /. Possible Challanges -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="budget" id="budget" class="form-control"
                                                    value="<?php echo e($proposal->budget); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Project Budget -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="yyyy-mm-dd"
                                                    ...
                                                    value="<?php echo e($proposal->submission_time); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Submission Date -->
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <select class="time-period" name="time_period">
                                                        <option value="Days" <?php if($proposal->time_period == 'Days'): ?> selected <?php endif; ?>>Days</option>
                                                        <option value="Month" <?php if($proposal->time_period == 'Month'): ?> selected <?php endif; ?>>Months</option>
                                                        <option value="Year" <?php if($proposal->time_period == 'Year'): ?> selected <?php endif; ?>>Year</option>
                                                    </select>
                                                </div>
                                                <input type="text" name="project_timeline" id="project_timeline"
                                                    class="form-control" value="<?php echo e($proposal->project_timeline); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. Project Timeline -->
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="social_impact_points" id="social_impact_points"
                                                    class="form-control" value="<?php echo e($proposal->social_impact_points); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            ...
                                            <a href="<?php echo e(url('/images/brochure/large/'.$proposal->brochure_pdf)); ?>" target="_blank" style="margin-top: 1em !important;"><img src="<?php echo e(url('/images/pdf.png')); ?>" width="20"> Brochure</a>
                                        </div>
                                    </div>
                                    <!-- /. PDF Brochure -->
...
<?php echo $__env->make('layouts.panel.design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\LIT\resources\views/admin/proposals/edit.blade.php ENDPATH**/ ?>