...
<body class="fixed_header">
    ...
    <div id="wrap">
        ...
        <!-- Wrapper Start here -->
        <div class="wrapper">
            <?php echo $__env->make('layouts.panel.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('layouts.panel.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('admin/vendors/chosen/js/chosen.jquery.min.js')); ?>"></script>
    <!-- global scripts end-->
    ...
    <script src="<?php echo e(asset('admin/js/pages/form_elements.js')); ?>"></script>
    ...
    <!-- Date & Time picker -->
    <script src="<?php echo e(asset('admin/vendors/jquery.uniform/js/jquery.uniform.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/vendors/inputlimiter/js/jquery.inputlimiter.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/js/pluginjs/jquery.validVal.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/vendors/datepicker/js/bootstrap-datepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/js/pages/datetime_piker.js')); ?>"></script>
...
</html><?php /**PATH D:\GITHUB\LIT\resources\views/layouts/panel/design.blade.php ENDPATH**/ ?>