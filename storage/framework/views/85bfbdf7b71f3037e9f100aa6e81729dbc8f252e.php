                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(!empty($item->feature_image)): ?> <img width="90" class="img-responsive" src="<?php echo e(asset('/images/successStory/large/'.$item->feature_image)); ?>" alt="<?php echo e($item->title); ?>"> <?php endif; ?></td>
