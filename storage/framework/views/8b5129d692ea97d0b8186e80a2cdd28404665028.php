        ...
        <div class="container-fluid m-0">
            ...
            <div class="navbar-toggleable-sm m-lg-auto d-none d-lg-flex top_menu" id="nav-content">
                <ul class="nav navbar-nav flex-row top_menubar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/admin/users')); ?>">
                            <i class="fa fa fa-edit"></i> <span class="quick_text">Users</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/admin/social-impact/initiatives')); ?>">
                            <i class="fa fa-map-marker"></i> <span class="quick_text">Social Initiatives</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(url('/admin/social-impact/proposals')); ?>">
                ...
                <div class="btn-group">
                    <div class="user-settings no-bg">
                        <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                            ...
                            <?php if(!empty(Auth::user()->avatar)): ?><img src="<?php echo e(asset('/images/user/large/'.Auth::user()->avatar)); ?>" class="admin_img2 rounded-circle avatar-img"
                                alt="Test"><?php else: ?>
...
<!-- /.Top ends here -->
<!-- /.Header ends here --><?php /**PATH D:\GITHUB\LIT\resources\views/layouts/panel/header.blade.php ENDPATH**/ ?>