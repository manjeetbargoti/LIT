                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Out Reach </th>
                                        <td> <?php echo e($instaCamp->outreach); ?> </td>
                                    </tr>
                                    <tr>
                                        <th> Duration </th>
                                    ...
                                    <tr>
                                        <th> Start Date </th>
                                        <td class="text-success"> <?php echo e(date('l, j F Y', strtotime($instaCamp->start_date))); ?> </td>
                                    </tr>
                                    <tr>
                                        <th> End Date </th>
                                        <td class="text-success"> <?php echo e(date('l, j F Y', strtotime($instaCamp->end_date))); ?> </td>
                                    </tr>
                                    <tr>
                                        <th> Budget </th>
                                        <td> USD <?php echo e($instaCamp->budget); ?> </td>
                                    </tr>
                                    <tr>
                                        <th> Address </th>
