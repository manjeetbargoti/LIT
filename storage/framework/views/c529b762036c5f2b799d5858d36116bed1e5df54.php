            ...
            <div class="col-md-6 m-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(url('/admin/sdgs')); ?>" accept-charset="UTF-8"
                            ...
                            <div class="form-group <?php echo e($errors->has('sdg_name') ? 'has-error' : ''); ?>">
                                ...
                                <input class="form-control" name="sdg_name" type="text" id="sdg_name"
                                    value="<?php echo e(old('sdg_name')); ?>" required>
                            ...
                            <div class="form-group <?php echo e($errors->has('sdg_description') ? 'has-error' : ''); ?>">
                                ...
                                <textarea name="sdg_description" id="SDGDescription" rows="5" class="form-control" value="<?php echo e(old('sdg_description')); ?>"></textarea>
...
<?php echo $__env->make('layouts.panel.design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\LIT\resources\views/admin/sdgs/create.blade.php ENDPATH**/ ?>